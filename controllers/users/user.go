...
import (
	...
	. "ApiManager/models/albums"
	. "ApiManager/models/knowledges"
	. "ApiManager/models/projects"
	. "ApiManager/models/users"
	"ApiManager/utils"
	"os"
	"strconv"
	"strings"
...
func (this *AddUserController) Post() {
	...
	if err == nil {
		...
		per.Model = "项目管理-project-book||project-manage,项目管理-project-book||project-manage,审批管理-approval-suitcase||#,知识分享-knowledge-tasks||knowledge-list,员工相册-album-plane||album-list"
