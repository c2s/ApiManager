// Copyright 2016 ApiManager Author. All Rights Reserved.
...
import (
	"ApiManager/controllers/albums"
	"ApiManager/controllers/businesstrips"
	"ApiManager/controllers/checkworks"
	"ApiManager/controllers/expenses"
	"ApiManager/controllers/goouts"
	"ApiManager/controllers/knowledges"
	"ApiManager/controllers/leaves"
	"ApiManager/controllers/messages"
	"ApiManager/controllers/oagoods"
	"ApiManager/controllers/overtimes"
	"ApiManager/controllers/projects"
	"ApiManager/controllers/resumes"
	"ApiManager/controllers/users"

	"github.com/astaxie/beego"
	"ApiManager/controllers/system"
)
...
func init() {
	...
	// 系统
	beego.Router("/system/manage", &system.ModuleManageController{})
